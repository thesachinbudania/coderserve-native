...
export default function TextAreaInput({ placeholder, maxLength = 1000, text, setText }: { placeholder: string, maxLength?: number, text: string, setText: React.Dispatch<React.SetStateAction<string>> }) {
