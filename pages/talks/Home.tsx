...
import { MenuButton } from "../jobs/Home";
  ...
  return (
    <View style={postStyles.container}>
      ...
      <View style={{ marginTop: 16 }}>
        <Image source={require('../profile/assets/Background/3.png')} style={postStyles.image} />
      </View>
    </View>
  );
}
        ...
        >
          <View style={{ flexDirection: "row", gap: 16 }}>
            <View style={styles.addHashContainer}>
              <Image source={require('../jobs/resume/assets/plus.png')} style={styles.addHashImage} />
            </View>
