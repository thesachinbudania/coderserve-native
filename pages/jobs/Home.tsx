import { Animated, Dimensions, Pressable, Keyboard, Image, ScrollView, StyleSheet, Text, View, useAnimatedValue } from 'react-native';
	...
	return (
		<View style={styles.headerContainer}>
			...
			<View style={{ gap: 16, flexDirection: 'row' }}>
				...
				>
					<Image source={require('../assets/Chats.png')} style={styles.headerIcon} />
				</IconButton>
				<IconButton
					onPress={() => {
...
function JobListing() {
	...
	return (
		<Pressable onPress={() => navigation.navigate('JobView')}>
			{({ pressed }) => (
				<View style={[jobStyles.container, pressed && { borderColor: '#006dff' }]}>
					<View style={{ flexDirection: 'row', gap: 16, alignItems: 'center' }}>
						<View style={jobStyles.logoContainer}>
							<Image source={require('./assets/capGemini.png')} style={jobStyles.logo} />
						</View>
						<View>
					...
					<Text style={[styles.heading, { marginTop: 16 }]}>Senior Salesforce Developer</Text>
...
function MenuButton({ children, dark = false, onPress = () => { } }: { children: React.ReactNode, dark?: boolean, onPress?: () => void }) {
	return (
		<Pressable onPress={() => {
	...
	return (
		<MenuButton>
			...
			<View style={countrySelectStyles.bottomContainer}>
				<Image source={require('./assets/pin.png')} style={countrySelectStyles.pin} />
							...
							>
								<View style={styles.menuContainer}>
									...
									<MenuButton onPress={() => {
										...
										<Text style={styles.menuButtonHeading}>
											Resume
										</Text>
									...
									<MenuButton
										dark
									>
										<Text style={[styles.menuButtonHeading, { color: 'white' }]}>
											Go Pro
										</Text>
