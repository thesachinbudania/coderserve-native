	...
	return (
		<View style={styles.topNavContainer}>
			...
			>
				{
					({ pressed }) => (
						<Image source={page === 0 ? leftMuted : pressed ? leftActive : leftArrow} style={styles.arrowButton} />
					)
				}
			</Pressable>
			...
			>
				{
					({ pressed }) => (
						<Image source={page === 1 ? rightMuted : pressed ? rightActive : rightArrow} style={styles.arrowButton} />
					)
				}
			</Pressable>
		</View>
...
export const setSuggestions = (text: string, setSuggestions: React.Dispatch<SetStateAction<any[]>>, suggestions: any[]) => {
