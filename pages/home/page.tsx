...
const HomeLabel: React.FC<IconProps> = ({ focused }) => (
  <Text
    style={[styles.iconLabelStyle, { color: focused ? "black" : "#d9d9d9" }]}
  >
    Home
  </Text>
);
...
const TalksIcon: React.FC<IconProps> = ({ focused }) => (
  <Image
    source={
      focused
        ? require("../assets/talksActive.png")
        : require("../assets/talks.png")
    }
    style={styles.icon}
  />
);
...
const JobsIcon: React.FC<IconProps> = ({ focused }) => (
  <Image
    source={
      focused
        ? require("../assets/jobsActive.png")
        : require("../assets/jobs.png")
    }
    style={styles.icon}
  />
);
...
const ProjectsIcon: React.FC<IconProps> = ({ focused }) => (
  <Image
    source={
      focused
        ? require("../assets/projectsActive.png")
    ...
    <NavigationContainer theme={MyTheme}>
      <SafeAreaView
        style={[
          ...
          Platform.OS === "ios" && styles.iosMargin,
        ]}
      >
        <Tab.Navigator
          screenOptions={{
        ...
        >
          <Tab.Screen
            name="Home"
            component={Home}
            options={{ tabBarIcon: HomeIcon, tabBarLabel: HomeLabel }}
          />
          <Tab.Screen
            name="Talks"
            component={Talks}
            options={{ tabBarIcon: TalksIcon, tabBarLabel: TalksLabel }}
          />
          <Tab.Screen
            name="Jobs"
            component={Jobs}
            options={{ tabBarIcon: JobsIcon, tabBarLabel: JobsLabel }}
          />
          <Tab.Screen
            name="Projects"
            component={Home}
            options={{ tabBarIcon: ProjectsIcon, tabBarLabel: ProjectsLabel }}
          />
          <Tab.Screen
            name="Profile"
            component={Profile}
            options={{ tabBarIcon: ProfileIcon, tabBarLabel: ProfileLabel }}
          />
        </Tab.Navigator>
      </SafeAreaView>
    </NavigationContainer>
